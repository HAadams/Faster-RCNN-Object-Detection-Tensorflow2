...
This repo shows how to train a Tensorflow v2-compatible model from the [Tensorflow v2 Model Zoo](https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/tf2_detection_zoo.md). Specifically, the ***Faster R-CNN ResNet50 V1 640x640*** model was trained using Berkely's DeepDrive Images and Labels (2020 version).
